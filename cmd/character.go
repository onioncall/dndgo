...
func init() {
	...
	addCmd.Flags().StringP("class-type", "c", "", "Specify class to perform action on if character is multiclass")
	...
	useCmd.Flags().StringP("class-type", "c", "", "Specify class to perform action on if character is multiclass")
	...
	recoverCmd.Flags().StringP("class-type", "c", "", "Specify class to perform action on if character is multiclass")
